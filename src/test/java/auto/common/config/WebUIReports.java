 ...
 * 报告美化
 */
public class WebUIReports implements IReporter {
...
//                String name = result.getMethod().getDescription();
                ...
                //auto.test.getModel().setDescription(description.toString());
                //auto.test = extent.createTest(result.getMethod().getMethodName());
